...
const static uint8_t fac_send_data[12] = {0xFF,0xFF,0xFF,0x09,0x00,0x00,0x01,0x6E,0x01,0x0A,0x00,0x83};
...
void rt_thread_entry_HandShake(void* parameter)
{
	...
	//	rt_device_write(cb->dev, 0, n_data, 2);			
		rt_thread_delay(200);
    } 			
}
