...
{
    {
        "/resource/rtthread_manual.zh.pdf",
        1024 * 128,
...
FINSH_FUNCTION_EXPORT_ALIAS(http_down, http_down, Download file from http server --filename --url.);
