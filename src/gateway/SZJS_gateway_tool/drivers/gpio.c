...
static const struct pin_index pins[] =
{
    ...
    { PIN_ISP_RESET         , RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_0},
    { PIN_ISP_BOOT          , RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_1},
    { PIN_BAT_DET           , RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_6},
    { PIN_BAT_CTRL          , RCC_AHB1Periph_GPIOA, GPIOA, GPIO_Pin_7},
