...
//#define UART6_TX_GPIO_RCC      RCC_AHB1Periph_GPIOG
...
#endif // RT_USING_UART2
#ifdef RT_USING_UART3
    struct serial_configure config_uart3 = UITD_USART_CFG_CONSOLE;
#endif // RT_USING_UART3
#ifdef RT_USING_UART4
    struct serial_configure config_uart4 = UITD_USART_CFG_CONSOLE;
#endif // RT_USING_UART4
#ifdef RT_USING_UART5
    struct serial_configure config_uart5 = UITD_USART_CFG_CONSOLE;
#endif // RT_USING_UART5
