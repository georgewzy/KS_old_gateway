...
//    rt_pin_write(PIN_TIM3_OUT       , PIN_LOW);     // default is LOW.
    ...
    // BAT :  
    rt_pin_mode(PIN_BAT_DET         , PIN_MODE_INPUT);
    rt_pin_mode(PIN_BAT_CTRL        , PIN_MODE_OUTPUT);
    
    rt_pin_write(PIN_BAT_CTRL        , PIN_HIGH);     // default is LOW.
    

    // STM32 ISP : RESET, BOOT
    rt_pin_mode(PIN_ISP_RESET        , PIN_MODE_OUTPUT);
    rt_pin_mode(PIN_ISP_BOOT        , PIN_MODE_OUTPUT);

    rt_pin_write(PIN_ISP_RESET       , PIN_HIGH);     // default is LOW.
    rt_pin_write(PIN_ISP_BOOT        , PIN_LOW);     // default is LOW.
