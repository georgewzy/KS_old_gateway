...
void sys_ctrl_handler(t_sys_ctrl *ctrl)
{
    ...
    else if (ctrl->sys_state == SYS_state_read_ID)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_on;
    ...
    else if (ctrl->sys_state == SYS_state_IAP_programing)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_flash_fast;
    ...
    else if (ctrl->sys_state == SYS_state_APP_programing)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_flash_fast;
    ...
    else if (ctrl->sys_state == SYS_state_APP_failed)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_off;
    ...
    else if (ctrl->sys_state == SYS_state_APP_success)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_on;
    ...
    else if (ctrl->sys_state == SYS_status_board_testing)
    {
        if (ctrl->sys_state != ctrl->sys_state_last)
        {
            ctrl->LED_green.mode = LED_flash_fast;
