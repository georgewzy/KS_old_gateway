...
typedef enum
{
    SYS_state_PWR_ON = 0, SYS_state_inited, SYS_state_idle, SYS_state_working, SYS_state_reconnect, SYS_state_PWR_OFF, SYS_state_shutdown,
    SYS_state_read_ID, SYS_state_IAP_programing, SYS_state_IAP_failed, SYS_state_IAP_success, SYS_state_APP_programing, 
    SYS_state_APP_failed, SYS_state_APP_success, SYS_status_board_testing, 
} e_sys_state;
...
#define THREAD_SYS_STATUS_STACK_SIZE     10240
