...
#define RMII_TX_GPIO_GROUP        3     /* 1:GPIOB or 2:GPIOG or 3: mixed */
...
//  assert_param(IS_ETH_PROMISCIOUS_MODE(ETH_InitStruct->ETH_PromiscuousMode));
  ...
  else /* ((hclk >= 120000000)&&(hclk <= 168000000)) */
  {
    /* CSR Clock Range between 120-168 MHz */
    tmpreg |= (uint32_t)ETH_MACMIIAR_CR_Div62;
  }
...
#define ETH_RXBUFNB        	2  // legacy is 4
...
#   if RMII_TX_GPIO_GROUP == 1
    ...
    /* configure PB11:RMII_TX_EN, PG13:RMII_TXD0, PB13:RMII_TXD1 */
...
static void phy_monitor_thread_entry(void *parameter)
{
    ...
    if(phy_addr == 0xFF)
    {
        ...
        SYS_log(SYS_DEBUG_ERROR, ("Eth: phy not probe! \n"));
        return;
    }
    else
    {
    ...
    while(1)
    {
        ...
        if(phy_speed_new != phy_speed)
        {
            if(phy_speed_new & PHY_LINK_MASK)
            {
                ...
                SYS_log(SYS_DEBUG_INFO, ("Eth: link up \n"));
                sys_config.eth_link_up = 1;
            ...
            else
            {
                ...
                SYS_log(SYS_DEBUG_INFO, ("Eth: link down \n"));
                /* send link down. */
...
void rt_hw_stm32_eth_init(void)
{
    ...
    stm32_eth_device.dev_addr[2] = 0xEF;
