...
//    uint32_t            send_index;
	...
	s_com_bus_R_alarm		alarm_shield;							//ÆÁ±Î
	s_com_bus_R_alarm		alarm_feedback;							//·´À¡
	s_com_bus_R_alarm		alarm_supervise;						//¼à¹Ü
	s_com_bus_R_alarm		alarm_start;							//Æô¶¯
	s_com_bus_R_reset   	alarm_outing;							//Ñ²¼ì
