...
// Song : added ,  2016-10-11 16:28:53
static rt_size_t fdevice_control(rt_device_t dev, rt_uint8_t cmd, void *arg)
{
    struct file_device *fdev = (struct file_device *)dev;
    struct dfs_fd *d;
    ...
    switch (cmd)
    {
        ...
        case LOG_TRACE_CTRL_RESET:
            ...
            // Song: TODO, change file lenght to 0.
            //dfs_file_lseek(d, 0);
            //dfs_file_flush(d);
...
void log_trace_file_init(const char *filename)
{
    ...
    if (device == RT_NULL)
    {
        ...
        // Song: modified, add flush function.
